        ...
        <div class="flex">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-10 sm:gap-2">
                ...
                <x-nav-link
                    ...
                    :active="request()->routeIs('modalidades.*')">
        ...
        <div class="hidden sm:flex sm:items-center sm:ms-6">
            ...
            <x-dropdown align="right" width="48">
                ...
                <x-slot name="trigger">
                    ...
                    <button class="inline-flex items-center gap-2 px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-600 bg-white hover:text-gray-900 focus:outline-none transition">

                        <div class="w-8 h-8 rounded-full bg-gray-900 text-white flex items-center justify-center font-bold">
